...
// ── Mock weekly chart data (replace with real API when available) ──────────────
const WEEKLY_DATA: WeeklyDataPoint[] = [
  { day: "Mon", submitted: 5, resolved: 2 },
  { day: "Tue", submitted: 8, resolved: 4 },
  { day: "Wed", submitted: 3, resolved: 3 },
  { day: "Thu", submitted: 11, resolved: 6 },
  { day: "Fri", submitted: 7, resolved: 5 },
  { day: "Sat", submitted: 4, resolved: 2 },
...
export const DashboardPage: React.FC<DashboardPageProps> = ({ complaints, isLoading }) => {
  // Derive stats from real complaint data
  ...
  // 5 most recent complaints for the quick-view table
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">
          Overview of complaint activity in Sta. Maria, Laguna
        </p>
      </div>
