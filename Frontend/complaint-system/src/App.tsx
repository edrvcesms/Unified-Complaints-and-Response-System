...
import { UsersGuidePage } from "./features/general/pages/UsersGuidePage"
...
function App() {
  ...
  return (
    <>
      {isAuthenticated && !["/delete-account", "/mary-app", "/users-guide"].includes(window.location.pathname) && <Navbar onLogout={clearAuth} />}
      <NetworkProvider>
        <Routes>
