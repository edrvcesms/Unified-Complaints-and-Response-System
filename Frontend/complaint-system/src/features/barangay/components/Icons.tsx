import { Menu, Home, CheckCircle, Clock, Eye, Send, Megaphone, CalendarDays } from "lucide-react"
...
export const AnnouncementsIcon = () => <Megaphone className="w-5 h-5" />;
export const EventsIcon = () => <CalendarDays className="w-5 h-5" />;
