...
export const emergencyQueueInstance = createApiInstance(`${BASE_URL}/emergency-queue`, true);
export const pushSubscriptionInstance = createApiInstance(`${BASE_URL}/web-push`, true);
...
export const emergencyQueueApi = createApiClient(emergencyQueueInstance);
export const pushSubscriptionApi = createApiClient(pushSubscriptionInstance);