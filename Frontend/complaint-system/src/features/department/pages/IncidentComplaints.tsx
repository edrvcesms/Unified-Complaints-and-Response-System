...
export const DepartmentIncidentComplaints: React.FC = () => {
  ...
  const handleComplaintClick = (complaintId: number) => {
    navigate(`/department/incidents/complaints/${complaintId}`);
  };
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <button
          onClick={() => navigate(`/department/incidents/${incidentId}`)}
...
export default DepartmentIncidentComplaints;
